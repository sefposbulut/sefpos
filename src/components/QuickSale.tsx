          ...
          <div className="bg-white w-full sm:max-w-md rounded-t-2xl sm:rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[92dvh]">
            ...
            <div className="p-4 overflow-y-auto space-y-3">
              ...
              <div className="text-[11px] text-slate-500 leading-relaxed">
                Ürün anında ürün listenize eklenir, kaydedilen barkod bir sonraki taramada doğrudan sepete iner. Detayları sonra "Stok / Reçete" veya "Ürünler" ekranından düzenleyebilirsiniz.
              </div>
            </div>
